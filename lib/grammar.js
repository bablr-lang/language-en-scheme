 ...
 * @generatedfrom ./grammar.macro.js#68d5361b36b0b6c0844de017b5e69680a1f3d9e2
 * This file is autogenerated. Please do not edit it directly.
 * When editing run `npx macrome watch` then change the file this is generated from.
 */
import _applyDecs from "@babel/runtime/helpers/applyDecs2305";
let _initProto, _NumberDecs, _BooleanDecs, _NullTagDecs, _KeywordDecs, _PunctuatorDecs, _ListDecs, _AnyDecs;
...
export const grammar = triviaEnhancer({
  ...
  *eatMatchTrivia() {
  ...
  static {
    [_initProto] = _applyDecs(this, [[Node, 2, "SExpr"], [Node, 2, "String"], [[AllowEmpty, Node], 2, "StringContent"], [_NumberDecs, 2, "Number"], [Node, 2, "Integer"], [Node, 2, "Literal"], [Node, 2, "Const"], [Node, 2, "Identifier"], [Node, 2, "UnsignedInteger"], [_BooleanDecs, 2, "Boolean"], [_NullTagDecs, 2, "NullTag"], [_KeywordDecs, 2, "Keyword"], [_PunctuatorDecs, 2, "Punctuator"], [_ListDecs, 2, "List"], [_AnyDecs, 2, "Any"]], []).e;
  }
  constructor() {
    _initProto(this);
  }
  *[(_NumberDecs = [CoveredBy('Expression'), Node], _BooleanDecs = [CoveredBy('Expression'), Node], _NullTagDecs = [CoveredBy('Expression'), Node], _KeywordDecs = [Node, InjectFrom(productions)], _PunctuatorDecs = [Node, InjectFrom(productions)], _ListDecs = [AllowEmpty, InjectFrom(productions)], _AnyDecs = InjectFrom(productions), Symbol.for('@bablr/fragment'))]({
    value: {
      productionName
    }
  }) {
